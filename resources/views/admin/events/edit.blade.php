                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" value="{{ $event->title }}" required class="w-full h-14 px-6 rounded-full bg-slate-50 border-slate-200 focus:border-primary focus:ring-primary transition-all font-bold text-slate-900">
                        </div>

                        <div>
                            <label class="text-sm font-black text-slate-700 ml-4 mb-2 block uppercase tracking-widest">Deskripsi Lengkap</label>
                            <textarea name="description" rows="8" required class="w-full px-6 py-4 rounded-[2rem] bg-slate-50 border-slate-200 focus:border-primary focus:ring-primary transition-all font-bold text-slate-900">{{ $event->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" name="date" value="{{ $event->date }}" required class="w-full h-14 px-6 rounded-full bg-slate-50 border-slate-200 focus:border-primary focus:ring-primary transition-all font-bold text-slate-900 appearance-none">
                            </div>
                            <div>
                                <label class="text-sm font-black text-slate-700 ml-4 mb-2 block uppercase tracking-widest">Waktu</label>
                                <input type="time" name="time" value="{{ $event->time }}" required class="w-full h-14 px-6 rounded-full bg-slate-50 border-slate-200 focus:border-primary focus:ring-primary transition-all font-bold text-slate-900 appearance-none">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="location" value="{{ $event->location }}" required class="w-full h-14 pl-14 pr-6 rounded-full bg-slate-50 border-slate-200 focus:border-primary focus:ring-primary transition-all font-bold text-slate-900">
                            </div>
                        </div>

                        <div class="p-8 bg-indigo-50 rounded-[2rem] border border-indigo-100 italic text-indigo-700 text-sm">
                            <h4 class="font-black mb-2 uppercase tracking-widest text-[10px]">Informasi:</h4>
                            Perubahan pada event akan langsung terlihat oleh pengunjung website di halaman Agenda.
                        </div>
                    </div>
                </div>
